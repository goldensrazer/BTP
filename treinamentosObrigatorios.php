      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#">Meus treinamentos</a></li>
    ...
    <section class="content-header">
      ...
      <div class="col-xs-12">
          <div class="box">
            ...
            while ($lineDados = $resultreinamento ->fetch(PDO::FETCH_ASSOC)) {
               
                if($lineDados['STATUS_TREINAMENTO'] == 'FEITO'){
                   $lineDados['STATUS_TREINAMENTO'] = '<span class="label label-success">feito</span>';
                }else if($lineDados['STATUS_TREINAMENTO'] == 'PENDENTE'){
                    $lineDados['STATUS_TREINAMENTO'] = '<span class="label label-warning">Pendente</span>';
                }
              echo " <tr><td>{$lineDados['NOME_TRMT']}</td> 
                    <td>{$lineDados['DATA_TREINAMENTO']} </td>
                    <td>{$lineDados['DATA_VENCIMENTO']} </td>
                    <td>{$lineDados['RECICLAGEM']}</td>
                    <td>{$lineDados['STATUS_TREINAMENTO']}</td>
                    </tr>";
              }?>
              </table>
            </div>
