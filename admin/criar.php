      ...
      <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Deixe um aviso para seu grupo</h3><br><br>
            ...
            <form role="form" method="POST" action="msg.php">
              <div class="box-body">
                <div class="form-group">
                 ...
                 <textarea class="form-control" rows="2" placeholder="Digite algo.." required id="msg" name="msg"></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">insira uma data:</label>
                  <input type="date" class="form-control" id="exampleInputPassword1" id="data" name="data" required>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="admin.php"><button type="button"  class="btn btn-danger">Cancelar</button></a>
              </div>
            </form>
          </div>
              <div class="box-tools">
